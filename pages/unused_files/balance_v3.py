...
def balancing_page():
    ...
    # Display the initial grid (if available)
    # if st.session_state.get("initial_grid"):
    #     st.subheader("Initial Ship Grid")
    #     initial_plot = plotly_visualize_grid(st.session_state["initial_grid"], title="Initial Ship Grid")
    #     st.plotly_chart(initial_plot)
...
#         # Create the initial frame (step 0)
#         frames = []
#         initial_grid = st.session_state.initial_grid

#         # Define figure data for the initial state
#         z = []  # Initialize base z values
#         annotations = []  # Initialize base annotations
...
#                             )
#                         ],
#                         layout=go.Layout(annotations=annotations_frame),
#                     )
#                 )
...
def balancing_page():
    ...
    # elif selected_tab == "Tab 3 Placeholder":
    #     st.subheader("Stepwise Animation of Ship Balancing")

    #     # Check if steps and grids are available
    #     if "steps" in st.session_state and "ship_grids" in st.session_state:
    #         if st.session_state.steps and st.session_state.ship_grids:
    #             # Generate and display the animation
    #             animation_fig = generate_stepwise_animation(
    #                 st.session_state.initial_grid,
    #                 st.session_state.steps,
    #                 st.session_state.ship_grids
    #             )
    ...
    #         else:
    #             st.write("No steps available for animation. Please balance the ship first!")
    #     else:
    #         st.write("No data available for animation. Please balance the ship first!")
